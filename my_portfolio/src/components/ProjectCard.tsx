  ...
  return (
    <>
      <div
        ...
        STablet:flex-col STablet:max-w-64 STablet:bg-none"
      >
        ...
        <div
          ...
          STablet:invisible"
        ></div>
        {/* Header section for STablet and above */}
        <div
          className="
        border-b-2 border-[#494d56] w-0 invisible
        STablet:h-52 STablet:w-full STablet:visible"
        >
          <img
        ...
        STablet:flex-row STablet:items-center STablet:border-b-2 STablet:border-r-0"
        >
          <div>HTML</div>
          <div>CSS</div>
          <div>Python</div>
        ...
        <div className="p-4">
          ...
          <div className="flex flex-row justify-start gap-10">
            ...
            <div
              className="border border-[#775288] px-2 py-1 text-white text-sm text-center
            STablet:w-1/4"
            >
              Live
            </div> */}
