    ...
    <div className="grid grid-cols-2 border-t-2 border-slate-400">
      <div className="col-span-1">
        <div className="flex flex-col Laptop:flex-row gap-5 pt-5">
          ...
          <div className="text-slate-400 hidden Laptop:flex">akeshramasinghe@gmail.com</div>
        </div>
      ...
      <div className="col-span-1 grid justify-center">
        ...
        <div className="flex flex-row gap-3">
          <div className="w-[20px] h-[20px]"><img src={email} className="w-full h-full object-fill"/></div>
          <div className="w-[20px] h-[20px]"><img src={github} className="w-full h-full object-fill"/></div>
          <div className="w-[20px] h-[20px]"><img src={linkedin} className="w-full h-full object-fill"/></div>
        </div>
      </div>
